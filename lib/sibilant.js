...
var namespace = false;
macros.defun__ADD = (function(args) {
  // args:rest
  var args = Array.prototype.slice.call(arguments, 0);
  ...
  return macros.defun.apply(undefined, args);
});

macros.defvar__ADD = (function(pairs) {
  // pairs:rest
  var pairs = Array.prototype.slice.call(arguments, 0);
  ...
  return (namespace + "." + (bulkMap(pairs, (function(name, value) {
    // name:required value:required
    return (translate(name) + " = " + translate(value));
  }))).join(";\n") + ";");
});

macros.ns = (function(name) {
  // name:required
  (function() {
    if (namespace) {
...
var translateAll = (function(contents) {
  ...
  (function() {
    if (namespace) {
      buffer = translate(("var " + namespace + " = (function() {" + indent(("var " + namespace + " = {};\n\n" + buffer + "return " + namespace + ";")) + "})();"));
